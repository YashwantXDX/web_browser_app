...
class _WebBrowserScreenState extends State<WebBrowserScreen> {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              onSubmitted: (value) {
                searchEngineUrl = "https://${textEditingController.text.toString()}/";
                loadUrl(searchEngineUrl);
              },
            )),
            IconButton(
  ...
  _buildBottomWidget() {
    return BottomNavigationBar(
      onTap: (value) {
        switch(value){
          case 0: webViewController.goBack();
          case 1: webViewController.goForward();
          case 2: webViewController.reload();
        }
      },
      items: const [
